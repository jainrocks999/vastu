    ...
    public function boot(): void
    {
        ...
        DashboardMenu::beforeRetrieving(function () {
            DashboardMenu::make()
                ...
                // ->registerItem([
                //     'id' => 'cms-plugins-ecommerce-product-course',
                //     'priority' => 20,
                //     'parent_id' => 'cms-plugins-ecommerce',
                //     'name' => 'Courses',
                //     'icon' => 'ti ti-package',
                //     'url' => fn () => route('products.create', ['product_type' => 'digital']),
                //     'permissions' => ['products.create'],
                // ])
                // ->registerItem([
                //     'id' => 'cms-plugins-ecommerce-course',
                //     'priority' => 30,
                //     'parent_id' => 'cms-plugins-ecommerce',
                //     'name' => 'Courses-list',
                //     'icon' => 'ti ti-package',
                //     'url' => fn () => route('course.index'),
                //     'permissions' => ['course.index'],
                // ])
                ->registerItem([
