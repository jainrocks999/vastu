...
return [
    ...
    'return_success' => 'Requested course(s) return successfully!',
    ...
    'incomplete_orders_intro_description' => 'Incomplete order is an order created when a customer adds a course to the cart, proceeds to fill out the purchase information but does not complete the checkout process.',
    'invoice_for_order' => 'Invoice for order',
    'created' => 'Created',
    'invoice' => 'Invoice',
    'return' => 'Order Return Request',
    'restock_courses' => 'Restock :count course(s)?',
    ...
    'number_of_courses_invalid' => 'Number of courses refund is not valid!',
    ...
    'refund' => 'Refund',
    'all_courses_are_not_delivered' => 'All courses are not delivered',
    'delivery' => 'Delivery',
    'history' => 'History',
    ...
    'see_maps' => 'See maps',
    'one_or_more_courses_dont_have_enough_quantity' => 'One or more courses don\'t have enough quantity!',
    ...
    'courses_available' => 'course(s) available',
    ...
    'add' => 'Add',
    'store' => 'Store',
    'please_choose_course_option' => 'Please choose course option',
    'sku_optional' => 'SKU (optional)',
    'with_storehouse_management' => 'With storehouse management?',
    'quantity' => 'Quantity',
    'allow_customer_checkout_when_this_course_out_of_stock' => 'Allow customer checkout when this course out of stock?',
    'address' => 'Address',
    'phone' => 'Phone',
    'country' => 'Country',
    'state' => 'State',
    ...
    'please_courses_and_customer_address_to_see_the_shipping_rates' => 'Please add courses and customer information with the complete shipping address to see the configured shipping rates',
    ...
    'search_or_create_new_course' => 'Search or create a new course',
    'search_or_create_new_customer' => 'Search or create a new customer',
    'discount_description' => 'Discount description',
    'cant_select_out_of_stock_course' => 'Cannot select out of stock course!',
    'referral' => 'Referral',
    ...
    'new_order_notifications' => [
        'new_order' => 'New order',
        'view' => 'View',
        'description' => ':customer ordered :quantity :course',
    ],
    ...
    'return_order_notifications' => [
        'return_order' => 'Return order',
        'description' => ':customer has requested return course(s)',
    ],
    ...
    'cancellation_reasons' => [
        'change-mind' => 'Changed mind or no longer needed the course',
    ...
    'requires_courses_to_create_order' => 'Please select at least one course to create order',
    ...
    'course_description' => 'Select the Course table to display in this course details',
