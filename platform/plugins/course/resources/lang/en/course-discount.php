...
return [
    ...
    'intro' => [
        ...
        'description' => 'Create coupon code or promotion for your courses.',
    ...
    'enums' => [
        ...
        'targets' => [
            ...
            // 'group-courses' => 'Course collections',
            // 'specific-course' => 'Specific course',
            'courses-by-category' => 'Courses by category',
        ],
    ],
    'discount' => 'Discount',
    ...
    'one_time_per_course_in_cart' => 'One time per course in cart',
    'number_of_courses' => 'Number of courses required to apply',
    ...
    'cannot_use_same_time_with_flash_sale' => 'This coupon cannot be used with flash sale items like :course_name. Please remove the item from your cart or choose a different coupon.',
];
