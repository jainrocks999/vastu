...
use Botble\Course\Events\CourseQuantityUpdatedEvent;
use Botble\Course\Events\CourseVariationCreated;
use Botble\Course\Http\Requests\SearchCourseAndVariationsRequest;
use Botble\Course\Http\Resources\AvailableCourseResource;
use Botble\Course\Facades\CourseHelper;
use Botble\Course\Models\Course;
use Botble\Course\Services\HandleApplyCouponService;
use Botble\Course\Services\HandleCourseOrderService;
use Exception;
