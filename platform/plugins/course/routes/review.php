...
AdminHelper::registerRoutes(function () {
    Route::group(['namespace' => 'Botble\Course\Http\Controllers', 'prefix' => 'course_review'], function () {
        Route::group(['prefix' => 'course_review', 'as' => 'course_review.'], function () {
...
//     Route::namespace('Botble\course\Http\Controllers\Fronts')->group(function () {
