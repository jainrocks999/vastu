...
class SaleCommissionHtml extends Html
{
    public function getContent(): string
    {
        ...
        $count['revenues'] = collect([
            [
                'label' => trans('plugins/franchise::franchise.reports.total_fee'),
                'value' => (float) $totalFee,
                'color' => Arr::first($colors),
            ],
            [
                'label' => trans('plugins/franchise::franchise.reports.total_amount'),
        ...
        $feeData = [
            'name' => trans('plugins/franchise::franchise.reports.fee', ['symbol' => $symbol]),
            'data' => [],
        ];

        $amountData = [
            'name' => trans('plugins/franchise::franchise.reports.amount', ['symbol' => $symbol]),
            'data' => [],
        ];
        ...
        return view('plugins/franchise::reports.widgets.sale-commissions', compact('count', 'salesReport'))->render();
    }
}
