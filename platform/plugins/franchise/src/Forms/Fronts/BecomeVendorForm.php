...
namespace Botble\Franchise\Forms\Fronts;
...
class BecomeVendorForm extends FormAbstract
{
    public function setup(): void
    {
        Theme::asset()
            ->container('footer')
            ->add('franchise-register', 'vendor/core/plugins/franchise/js/customer-register.js', ['jquery']);
        ...
        $this
            ...
            ->setUrl(route('franchise.vendor.become-vendor.post'))
            ->add(
                'is_vendor',
                'hidden',
            ...
            ->when(FranchiseHelper::getSetting('requires_vendor_documentations_verification', true), function () {
                $this
                    ->add(
            ...
            ->add(
                ...
                CheckboxFieldOption::make()
                    ->when(
                        $privacyPolicyUrl = FranchiseHelper::getSetting('term_and_privacy_policy_url') ?: theme_option('term_and_privacy_policy_url'),
