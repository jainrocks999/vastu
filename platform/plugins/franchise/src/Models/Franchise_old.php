...
use Botble\Franchise\Enums\DiscountTypeEnum;
use Botble\Franchise\Notifications\ConfirmEmailNotification;
use Botble\Franchise\Notifications\ResetPasswordNotification;
...
class Franchise extends BaseModel implements
    ...
    CanResetPasswordContract
{
    ...
    protected $casts = [
        'status' => FranchiseStatusEnum::class
    ];
