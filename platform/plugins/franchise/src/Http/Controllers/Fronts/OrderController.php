...
use Botble\Franchise\Tables\OrderTable;
...
class OrderController extends BaseController
{
    ...
    public function edit(int|string $id)
    {
        ...
        return FranchiseHelper::view('vendor-dashboard.orders.edit', compact('order', 'weight', 'defaultStore'));
    }
    ...
    {
        if (! FranchiseHelper::allowVendorDeleteTheirOrders()) {
            abort(403);
        }
