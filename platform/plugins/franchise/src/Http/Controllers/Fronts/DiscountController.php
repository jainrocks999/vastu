...
use Botble\Franchise\Http\Requests\Fronts\DiscountRequest;
use Botble\Franchise\Tables\DiscountTable;
use Exception;
...
class DiscountController extends BaseController
{
    ...
    public function create()
    {
        ...
        Assets::addStylesDirectly(['vendor/core/plugins/ecommerce/css/ecommerce.css'])
            ->addScriptsDirectly([
                'vendor/core/plugins/franchise/js/discount.js',
            ])
        ...
        $jsValidation = JsValidator::formRequest(DiscountRequest::class, '#franchise-vendor-discount');

        return FranchiseHelper::view('vendor-dashboard.discounts.create', compact('jsValidation'));
    }
    ...
    public function store(DiscountRequest $request)
    {
        ...
        return $this
            ->httpResponse()
            ->setNextUrl(route('franchise.vendor.discounts.index'))
