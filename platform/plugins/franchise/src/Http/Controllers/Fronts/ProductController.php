...
use Botble\Franchise\Forms\ProductForm;
use Botble\Franchise\Tables\ProductTable;
use Botble\Franchise\Tables\ProductVariationTable;
...
class ProductController extends BaseController
{
    ...
    public function store(
        ...
        $product->status = FranchiseHelper::getSetting(
        ...
        if (FranchiseHelper::getSetting('enable_product_approval', 1)) {
        ...
        return $this
            ->httpResponse()
            ->setPreviousUrl(route('franchise.vendor.products.index'))
            ->setNextUrl(route('franchise.vendor.products.edit', $product->getKey()))
    ...
    public function getRelationBoxes($id)
    {
        ...
        $dataUrl = route(
            'franchise.vendor.products.get-list-product-for-search',
    ...
    public function getVersionForm(int|string|null $id, Request $request)
    {
        ...
        return $this
            ->httpResponse()
            ->setData(
                FranchiseHelper::view('vendor-dashboard.products.product-variation-form', compact(
