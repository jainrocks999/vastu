...
use Botble\Franchise\Http\Requests\Fronts\UpdateShippingStatusRequest;
use Botble\Franchise\Tables\ShipmentTable;
use Carbon\Carbon;
use Exception;
...
class ShipmentController extends BaseController
{
    ...
    public function edit(int|string $id)
    {
        ...
        return FranchiseHelper::view('vendor-dashboard.shipments.edit', compact('shipment'));
    }
    ...
    public function postUpdateStatus(int|string $id, UpdateShippingStatusRequest $request)
    {
        ...
        if (
            ! FranchiseHelper::allowVendorManageShipping() &&
            ! in_array($status, [
    ...
    public function update(int|string $id, ShipmentRequest $request)
    {
        ...
        return $this->httpResponse()
            ->setPreviousUrl(route('franchise.vendor.shipments.index'))
