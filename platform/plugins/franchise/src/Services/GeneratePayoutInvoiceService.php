...
use Botble\Franchise\Enums\PayoutPaymentMethodsEnum;
...
class GeneratePayoutInvoiceService
{
    ...
    {
        return plugin_path('franchise/resources/templates/payout-invoice.tpl');
    }

    public function getCustomizedTemplatePath(): string
    {
        return storage_path('app/templates/franchise/payout-invoice.tpl');
    }

    public function getVariables(): array
    {
        return [
            'company.logo' => trans('plugins/franchise::withdrawal.invoice.variables.company_logo'),
            'company.name' => trans('plugins/franchise::withdrawal.invoice.variables.company_name'),
            'company.address' => trans('plugins/franchise::withdrawal.invoice.variables.company_address'),
            'company.state' => trans('plugins/franchise::withdrawal.invoice.variables.company_state'),
            'company.city' => trans('plugins/franchise::withdrawal.invoice.variables.company_city'),
            'company.zipcode' => trans('plugins/franchise::withdrawal.invoice.variables.company_zipcode'),
            'company.phone' => trans('plugins/franchise::withdrawal.invoice.variables.company_phone'),
            'company.email' => trans('plugins/franchise::withdrawal.invoice.variables.company_email'),
            'company.tax_id' => trans('plugins/franchise::withdrawal.invoice.variables.company_tax_id'),
            'withdrawal.id' => trans('plugins/franchise::withdrawal.invoice.variables.withdrawal_id'),
            'withdrawal.created_at' => trans('plugins/franchise::withdrawal.invoice.variables.withdrawal_created_at'),
            'withdrawal.customer.name' => trans('plugins/franchise::withdrawal.invoice.variables.withdrawal_customer_name'),
            'withdrawal.payment_channel' => trans('plugins/franchise::withdrawal.invoice.variables.withdrawal_payment_channel'),
            'withdrawal.amount' => trans('plugins/franchise::withdrawal.invoice.variables.withdrawal_amount'),
            'withdrawal.fee' => trans('plugins/franchise::withdrawal.invoice.variables.withdrawal_fee'),
            'withdrawal_fee_percentage' => trans('plugins/franchise::withdrawal.invoice.variables.withdrawal_fee_percentage'),
            'withdrawal_status' => trans('plugins/franchise::withdrawal.invoice.variables.withdrawal_status'),
            'withdrawal.description' => trans('plugins/franchise::withdrawal.invoice.variables.withdrawal_description'),
            'withdrawal.bank_info.name' => trans('plugins/franchise::withdrawal.invoice.variables.withdrawal_bank_info_name'),
            'withdrawal.bank_info.number' => trans('plugins/franchise::withdrawal.invoice.variables.withdrawal_bank_info_number'),
            'withdrawal.bank_info.full_name' => trans('plugins/franchise::withdrawal.invoice.variables.withdrawal_bank_info_full_name'),
        ];
    }
