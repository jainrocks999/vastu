...
namespace Botble\Franchise\Supports;
...
class FranchiseHelper
{
    ...
    {
        if ($checkViewExists && view()->exists($themeView = Theme::getThemeNamespace('views.franchise.' . $view))) {
            return $themeView;
        }

        return 'plugins/franchise::themes.' . $view;
    }
    ...
    {
        return config('plugins.franchise.general.prefix') . $key;
    }
    ...
    {
        return EmailHandler::setModule(FRANCHISE_MODULE_SCREEN_NAME)
