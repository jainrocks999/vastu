...
<header class="header--mobile">
    ...
    <div class="header__center">
        <a
            class="ps-logo"
            href="{{ route('franchise.vendor.dashboard') }}"
        >
...
<aside class="ps-drawer--mobile">
    ...
    <div class="ps-drawer__content">
        @include(FranchiseHelper::viewPath('vendor-dashboard.layouts.menu'))
    </div>
</aside>
        ...
        <header class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div class="d-flex align-items-center gap-4">
                @if (is_plugin_active('language'))
                    {!! apply_filters('franchise_vendor_dashboard_language_switcher', view(FranchiseHelper::viewPath('vendor-dashboard.partials.language-switcher'))->render()) !!}
                @endif
