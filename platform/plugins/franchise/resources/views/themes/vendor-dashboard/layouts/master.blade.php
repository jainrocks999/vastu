...
<head>
    ...
    @yield('header', view(FranchiseHelper::viewPath('vendor-dashboard.layouts.header')))
    ...
    <script type="text/javascript">
        'use strict';
        window.trans = Object.assign(window.trans || {}, JSON.parse('{!! addslashes(json_encode(trans('plugins/franchise::franchise'))) !!}'));
        ...
        var RV_MEDIA_URL = {
            'media_upload_from_editor': '{{ route('franchise.vendor.upload-from-editor') }}'
        };
    </script>
...
@yield('body', view(FranchiseHelper::viewPath('vendor-dashboard.layouts.body')))
...
{!! Assets::renderFooter() !!}
@yield('footer', view(FranchiseHelper::viewPath('vendor-dashboard.layouts.footer')))
