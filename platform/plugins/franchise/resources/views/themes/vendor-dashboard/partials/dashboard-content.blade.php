    ...
    @if (!$totalProducts)
        <div class="col-12">
            ...
            >
                ...
                <hr>
                <p class="mb-0">{!! BaseHelper::clean(__('Create a new product <a href=":url">here</a>', ['url' => route('franchise.vendor.products.create')])) !!}</p>
            </div>
        </div>
    @elseif (!$totalOrders)
        <div class="col-12">
            ...
            <x-core::card class="mb-3">
                <x-core::card.header>
                    <div>
                        ...
                        <x-core::card.subtitle>
                            <a href="{{ route('franchise.vendor.revenues.index') }}">
                ...
                <x-core::table.body>
                    <div id="sales-report-chart">
                        <sales-reports-chart
                            url="{{ route('franchise.vendor.chart.month') }}"
    ...
    @if ($totalOrders)
        <div class="col-12">
            <x-core::card class="mb-3">
                            ...
                            @forelse ($data['orders'] as $order)
                                <x-core::table.body.row>
                                    <x-core::table.body.cell>
                                        <a href="{{ route('franchise.vendor.orders.edit', $order->id) }}">
                ...
                <x-core::card.footer>
                    <a href="{{ route('franchise.vendor.orders.index') }}">
                        {{ __('View Full Orders') }}
    ...
    @if ($totalProducts)
        <div class="col-12">
            <x-core::card>
                        ...
                        <x-core::table.body>
                            @forelse ($data['products'] as $product)
                                <x-core::table.body.row>
                                    ...
                                    <x-core::table.body.cell>
                                        <a href="{{ route('franchise.vendor.products.edit', $product->id) }}">
                                            {{ $product->name }}
                                        </a>
                                    </x-core::table.body.cell>
                                    <x-core::table.body.cell>
                ...
                <x-core::card.footer>
                    <a href="{{ route('franchise.vendor.products.index') }}">
