    ...
    <x-core::datagrid>
        <x-core::datagrid.item>
            ...
            @if (FranchiseHelper::allowVendorManageShipping())
                <a
                    href="{{ route('franchise.vendor.shipments.edit', $shipment->id) }}"
                    target="_blank"
                >
...
<x-core::card.footer class="shipment-actions-wrapper btn-list">
    ...
    <x-core::button tag="a" :href="route('franchise.vendor.shipments.print', $shipment)" target="_blank" icon="ti ti-printer">
