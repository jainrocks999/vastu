<div class="btn-list">
    <x-core::button
        ...
        :data-target="route('franchise.vendor.products.delete-versions')"
    ...
    <x-core::button
        ...
        :data-target="route('franchise.vendor.products.store-related-attributes', $product->id)"
    >
    ...
    <x-core::button
        ...
        :data-target="route('franchise.vendor.products.generate-all-versions', $product->id)"
    >
    ...
    <x-core::button
        ...
        :data-target="route('franchise.vendor.products.add-version', $product->id)"
        :data-load-form="route('franchise.vendor.products.get-version-form', ['id' => 0, 'product_id' => $product->id])"
