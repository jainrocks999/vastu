...
<script>
    ...
    $(document).ready(function() {
        var dropzone = new Dropzone('#{{ $id }}-upload', {
            ...
            timeout: 0, // MB,
            maxFilesize: {{ FranchiseHelper::maxFilesizeUploadByVendor() }}, // MB
            maxFiles: {{ FranchiseHelper::maxProductImagesUploadByVendor() }}, // max files upload,
            paramName: 'file',
            acceptedFiles: 'image/*',
            url: '{{ route('franchise.vendor.upload') }}',
            ...
            removedfile: function(file) {
                ...
                if (dropzone.options.maxFiles ===
                    {{ FranchiseHelper::maxProductImagesUploadByVendor() }}) {
