<x-core::form.fieldset
    ...
    @style(['display: none' => ! old('enable_commission_fee_for_each_category', FranchiseHelper::isCommissionCategoryFeeBasedEnabled())])
>
                ...
                >
                    <div class="col-3">
                        <x-core::form.text-input
                            :label="trans('plugins/franchise::franchise.settings.commission_fee')"
                    ...
                    <div class="col-9">
                        <x-core::form.label for="commission_fee_for_each_category">
                            {{ trans('plugins/franchise::franchise.settings.categories') }}
                        </x-core::form.label>
                        <div class="row">
                            <div class="col-10">
                                <x-core::form.textarea
                                    ...
                                    placeholder="{{ trans('plugins/franchise::franchise.settings.select_categories') }}"
                                >
            ...
            >
                ...
                <div class="col-9">
                    <x-core::form.label
                        ...
                        :label="trans('plugins/franchise::franchise.settings.categories')"
                    />
                    <div class="row">
                        <div class="col-10">
                            <x-core::form.textarea
                                ...
                                rows="3"
                                :value="setting('franchise_commission_by_category')"
                                placeholder="{{ trans('plugins/franchise::franchise.settings.select_categories') }}"
                            />
                        </div>
                    </div>
    ...
    <x-core::button color="primary" data-bb-toggle="commission-category-add">
        {{ trans('plugins/franchise::franchise.settings.add_new') }}
    </x-core::button>
</x-core::form.fieldset>
